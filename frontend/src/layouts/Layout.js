        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-nowrap items-center justify-between gap-4 py-3 min-h-[4rem] sm:py-4 sm:h-16 overflow-visible">
            ...
            <div className="flex flex-nowrap items-center gap-2 sm:gap-4 flex-shrink-0">
              ...
              <Link
                to="/profile"
                className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-300 shrink-0 hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors"
                title={user?.email}
                aria-label={user?.email ? `User: ${user.email}` : 'Go to profile'}
              >
